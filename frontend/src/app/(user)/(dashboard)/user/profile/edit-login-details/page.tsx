...
const selectClassName =
  "rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-800 shadow-sm outline-none transition-all focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20";
          ...
          <FormRow label="Hide Contact Details">
            <div className="space-y-2">
              <YesNoRadioGroup
                ...
                yesLabel="Yes"
              />
              <p className="rounded-lg bg-slate-50 px-3 py-2.5 text-xs leading-relaxed text-slate-500 sm:bg-transparent sm:px-0 sm:py-0">
